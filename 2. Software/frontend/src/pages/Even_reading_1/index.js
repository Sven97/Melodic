...
export default function Even_reading_1() {
  const data = {};
  ...
  return (
    <div className={`flex-col ${styles['page']} `}>
      ...
      <div className={`justify-center ${styles['divider_1']} `}>
        ...
        <span className={`${styles['text_13']} `}>Rate: 94.38%</span>
      </div>
      <div className={`flex-col ${styles['section_2']} `}>
        <img
          src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433599740218763431.png"
          className={`${styles['image_2']} `}
        />
        <span className={`${styles['text_14']} `}>PERFECT</span>
      </div>
