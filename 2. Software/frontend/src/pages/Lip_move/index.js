...
export default function Lip_move() {
  const data = {};
  ...
  return (
    <div className={`flex-col ${styles['page']} `}>
      ...
      <div className={`flex-col ${styles['group_3']} `}>
        <div className={`justify-end ${styles['group_4']} `}>
          <img
        ...
        <div className={`flex-col ${styles['group_5']} `}>
          <div className={`flex-row ${styles['group_6']} `}>
            <img
              src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601019999630758.png"
              className={`${styles['image_4']} `}
            />
            <img
              src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601019993206366.png"
              className={`${styles['image_5']} `}
            />
            <img
              src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601019993338528.png"
              className={`${styles['image_6']} `}
            />
            <div className={`${styles['divider_1']} `}></div>
            <div className={`flex-col ${styles['section_2']} `}>
              <div className={`flex-col items-end ${styles['image-wrapper']} `}>
                <img
                  src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433599689686792468.png"
                  className={`${styles['image_7']} `}
                />
              </div>
            </div>
            <img
              src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601020008097435.png"
              className={`${styles['image_8']} `}
            />
            <img
              src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601020003705325.png"
              className={`${styles['image_9']} `}
            />
          </div>
          <img
            src="https://project-user-resource-1256085488.cos.ap-guangzhou.myqcloud.com/61f3ae885a7e3f0310e2d6a4/61f3aeaba4955900114d556d/16433601020008555031.png"
